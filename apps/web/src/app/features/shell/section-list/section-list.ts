      ...
      @if (!state.selectedNotebookId()) {
        ...
        @for (sec of state.sections(); track sec.id) {
          <div
            ...
            [class.bg-accent-100]="sec.id === state.selectedSectionId()"
            [class.dark:bg-accent-900]="sec.id === state.selectedSectionId()"
            ...
            [class.ring-accent-300]="state.draggingType() === 'note'"
            [class.dark:ring-accent-600]="state.draggingType() === 'note'"
          ...
          >
            ...
            @if (editingId() === sec.id) {
              ...
              <span class="min-w-0 flex-1 truncate" [title]="sec.title">{{ sec.title }}</span>
