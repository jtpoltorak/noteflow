...
@Component({
  ...
  template: `
    ...
    <header class="border-b border-gray-200 bg-white px-6 py-3 dark:border-gray-700 dark:bg-gray-900">
      <a routerLink="/" class="text-lg font-bold text-blue-600 dark:text-blue-400">NoteFlow</a>
    </header>
    ...
    <main class="mx-auto max-w-3xl px-6 py-8">
      @if (loading()) {
        ...
        <div class="flex flex-col items-center justify-center py-20 text-center">
          ...
          <a routerLink="/" class="text-blue-500 hover:text-blue-600 dark:text-blue-400">Go to NoteFlow</a>
        </div>
      } @else if (note()) {
    ...
    <footer class="border-t border-gray-200 px-6 py-4 text-center text-xs text-gray-400 dark:border-gray-700 dark:text-gray-500">
      Shared via <a routerLink="/" class="text-blue-500 hover:text-blue-600 dark:text-blue-400">NoteFlow</a>
    </footer>
  `,
  host: {
